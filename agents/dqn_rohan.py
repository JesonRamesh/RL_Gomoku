...
class PrioritizedReplayBuffer:
    ...
    def sample(self, batch_size, beta=0.4):
        ...
        return states, actions, rewards, next_states, dones, player_ids, indices, weights
...
class DQNAgentRohan(BaseAgent):
    ...
    def __init__(self, player_id, board_size=9, learning_rate=5e-5, gamma=0.99, 
                 epsilon_start=1.0, epsilon_end=0.05, epsilon_decay=0.9995, 
                 buffer_capacity=100000, target_update_frequency=500):
        ...
        # Initialize networks
        self.q_network = DQNetworkRohan(board_size)
        self.target_network = DQNetworkRohan(board_size)
        ...
        print(f"DQNAgentRohan using device: {self.device}")
